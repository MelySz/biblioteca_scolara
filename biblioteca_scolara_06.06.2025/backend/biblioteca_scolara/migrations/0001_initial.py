# Generated by Django 5.1.6 on 2025-02-20 18:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publicatie', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1900), django.core.validators.MaxValueValidator(2025)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tip', models.CharField(blank=True, choices=[('elev', 'Elev'), ('bibliotecar', 'Bibliotecar')], max_length=15, null=True)),
                ('nume', models.CharField(max_length=255)),
                ('prenume', models.CharField(max_length=255)),
                ('data_nasterii', models.DateField()),
                ('clasa', models.CharField(blank=True, max_length=20, null=True)),
                ('oras', models.CharField(blank=True, max_length=100, null=True)),
                ('poza', models.ImageField(blank=True, default='default/library.jpg', null=True, upload_to='poze_utilizatori/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('utilizator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='imprumuturi', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('utilizator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recenzii', to=settings.AUTH_USER_MODEL)),
            ],
            options={
