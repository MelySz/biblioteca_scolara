        ...
        <div className="flex flex-grow w-full mt-16">
          ...
          <div className="w-64 text-white flex flex-col p-8 bg-black bg-opacity-40">
            ...
            <div className="border-b border-white pb-4 text-center">
              <h2 className="text-md font-semibold">Administrare Biblioteca</h2>
            ...
            <nav className="flex flex-col flex-grow mt-4 space-y-4">
              <ul className="flex flex-col space-y-3">
                ...
                <li><Link to="/imprumuturi" className="hover:text-yellow-400 transition-colors duration-200">📜 Împrumuturi</Link></li>
                <li><Link to="/recenzii" className="hover:text-yellow-400 transition-colors duration-200">✅ Aprobă recenzii</Link></li>
