...
import RapoarteUtilizatori from "./pages/RapoarteUtilizatori";
import RapoarteCarti from "./pages/RapoarteCarti";
import RapoarteImprumuturi from "./pages/RapoarteImprumuturi";
import RapoarteRecenzii from "./pages/RapoarteRecenzii";
...
import DashboardRecenziileMele from "./pages/DashboardRecenziileMele";
import AdaugareRecenzie from "./pages/AdaugareRecenzie";
import RecenziiAprobateElev from "./pages/RecenziiAprobateElev";
import RecenziiInAsteptareElev from "./pages/RecenziiInAsteptareElev";
import RecenziiRespinseElev from "./pages/RecenziiRespinseElev";
    ...
    <div className="relative min-h-screen flex flex-col">
      ...
      <div className="flex-grow">
        <Routes>
          ...
          <Route path="/rapoarte" element={<ProtectedRoute element={<LayoutBibliotecar><DashboardRapoarte /></LayoutBibliotecar>} allowedType="bibliotecar" />} />
          <Route path="/rapoarte/utilizatori" element={<ProtectedRoute element={<LayoutBibliotecar><RapoarteUtilizatori /></LayoutBibliotecar>} allowedType="bibliotecar" />} />
          <Route path="/rapoarte/carti" element={<ProtectedRoute element={<LayoutBibliotecar><RapoarteCarti /></LayoutBibliotecar>} allowedType="bibliotecar" />} />
          <Route path="/rapoarte/imprumuturi" element={<ProtectedRoute element={<LayoutBibliotecar><RapoarteImprumuturi /></LayoutBibliotecar>} allowedType="bibliotecar" />} />
          <Route path="/rapoarte/recenzii" element={<ProtectedRoute element={<LayoutBibliotecar><RapoarteRecenzii /></LayoutBibliotecar>} allowedType="bibliotecar" />} />
          ...
          <Route path="/dashboard-recenziile-mele" element={<ProtectedRoute element={<LayoutElev><DashboardRecenziileMele /></LayoutElev>} allowedType="elev" />} />
          <Route path="/recenzii/adaugare" element={<ProtectedRoute element={<LayoutElev><AdaugareRecenzie /></LayoutElev>} allowedType="elev" />} />
          <Route path="/recenziile-mele/aprobate" element={<ProtectedRoute element={<LayoutElev><RecenziiAprobateElev /></LayoutElev>} allowedType="elev" />} />
          <Route path="/recenziile-mele/in-asteptare" element={<ProtectedRoute element={<LayoutElev><RecenziiInAsteptareElev /></LayoutElev>} allowedType="elev" />} />
          <Route path="/recenziile-mele/respinse" element={<ProtectedRoute element={<LayoutElev><RecenziiRespinseElev /></LayoutElev>} allowedType="elev" />} />
