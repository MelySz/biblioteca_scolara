  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <form
        ...
        className="bg-white/90 backdrop-blur-md p-4 rounded-lg shadow"
      >
        <div className="flex flex-wrap gap-4 items-center">
          ...
          <button
            type="submit"
            className="bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 text-sm rounded shadow w-auto flex items-center gap-1"
          >
      ...
      {/* Lista recenzii */}
      <div className="bg-white/90 backdrop-blur-md p-6 rounded-xl shadow-lg max-h-[75vh] overflow-y-auto scroll-custom space-y-4">
        {loading ? (
