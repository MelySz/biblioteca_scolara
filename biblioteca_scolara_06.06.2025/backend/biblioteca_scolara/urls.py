...
from biblioteca_scolara.views import (
    ...
    RecenzieListView, AprobareRecenzieView, RespingereRecenzieView, StergereRecenzieView, RecenziileMeleAprobateView, RecenziileMeleInAsteptareView, RecenziileMeleRespinseView,
...
urlpatterns = [
    ...
    path("recenzii/<int:pk>/respingere/", RespingereRecenzieView.as_view(), name="respingere-recenzie"),
    path("recenzii/<int:pk>/", StergereRecenzieView.as_view(), name="sterge-recenzie"),
    path("recenzii/aprobate-elev/", RecenziileMeleAprobateView.as_view(), name="recenzii-aprobate-elev"),
    path("recenzii/in-asteptare-elev/", RecenziileMeleInAsteptareView.as_view(), name="recenzii-in-asteptare-elev"),
    path("recenzii/respinse-elev/", RecenziileMeleRespinseView.as_view(), name="recenzii-respinse-elev"),
